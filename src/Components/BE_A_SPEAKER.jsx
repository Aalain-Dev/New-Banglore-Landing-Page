        ...
        <div className="container">
          <div className="flex flex-col justify-center item-center xl:gap-5 gap-5">
            ...
            <p className='text-center xl:text-[1.25rem] text-[1rem] text-black'>
              We’re always looking to collaborate with thought leaders who are willing to push the limits to shape the startup ecosystem. If you would like to propose be a speaker, please submit your application by clicking on the button below. If we think there could be a good fit, a member of our team will be in touch with you. Applications close on  10<sup>th</sup>, June 2025.
            </p>
