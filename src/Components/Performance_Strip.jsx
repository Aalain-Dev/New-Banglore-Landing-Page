       ...
       <div className="grid xl:grid-cols-5 lg:grid-cols-5 md:grid-cols-2 gap-10 grid-cols-2 place-items-center mt-10 justify-between">
      {
        data.map((item,index)=>{
            return(
                ...
                <p className="text-white xl:text-6xl xl:text-[2.5rem] text-[20px]  font-bold text-center">{item.title}
                </p>
                <p className="text-white xl:text-xl xl:font-bold xl:text-[20px]  text-[20px] text-center font-semibold">{item.subtitle}</p>
                       </div>
                </div>
            )
        })
