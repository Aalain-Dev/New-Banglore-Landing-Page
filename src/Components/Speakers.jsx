...
<div
  className={`relative bg-white bg-opacity-30 backdrop-blur-lg w-[300px] sm:w-[400px] h-full shadow-lg p-6 overflow-y-auto rounded-l-2xl transform transition-all duration-500 ease-in-out ${
