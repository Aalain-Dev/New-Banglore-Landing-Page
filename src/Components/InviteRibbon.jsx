...
const InviteBanner = () => {
  ...
  return (
    <div className="container">
        <section className="relative bg-[#211F52] overflow-hidden px-6  py-2 mb-10 xl:pt-10 pt-5 pb-10" data-aos="fade-down">
      {/* Optional background image */}

      <div className="relative flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto gap-4">
        <h2 className="text-xl md:text-2xl font-medium text-white text-center md:text-left capitalize">
